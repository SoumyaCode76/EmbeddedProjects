...
extern uint32_t BSP_GetVersion(void);
...
extern void     BSP_PB_Init(Button_TypeDef Button, ButtonMode_TypeDef ButtonMode);
extern uint32_t BSP_PB_GetState(Button_TypeDef Button);
...
int main(void)
{
  ...
  while (1)
  { 
    printf("STM32F4xx LTDC Example : Displaying two layers with Blending \n");
